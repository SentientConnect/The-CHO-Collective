...
// NOTE: These are placeholder testimonials. Replace with verified member feedback.
export const testimonials: Testimonial[] = [
  {
    quote:
      "[Placeholder testimonial] Since joining the Collective, my referrals have become consistent and my team actually looks forward to Mondays. This is editable copy.",
  ...
  {
    quote:
      "[Placeholder testimonial] Edwin helped me lead with energy instead of pressure. Our culture and our numbers both improved. Replace with a verified quote.",
  ...
  {
    quote:
      "[Placeholder testimonial] The 10-week journey gave me practical tools I still use every week. My clients feel the difference. This text is editable.",
    name: "Placeholder Name Three",
    role: "Executive Coach, Placeholder Studio",
